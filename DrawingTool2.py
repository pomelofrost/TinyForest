...
while drawing:
    ...
    if 1180 < mouse[0] < 1220 and 740 < mouse[1] < 780:
        TextSurf = onHoverFont.render('DONE', True, (38,30,140))
        ...
        if click[0] == 1 and lineStart != (0,0):
            ...
            pygame.image.save(drawArea,'input2.jpg')
            drawing = False
    #not on hover
    else:
        TextSurf = onHoverFont.render('DONE',True, (38,30,140))
        TextRect = TextSurf.get_rect()
        TextRect.center = buttonPos
    QuestionSurf = onHoverFont.render(prompt, True, (38,30,140))
